namespace SistemasVentas.VISTA.ClienteVistaVend
{
	partial class ClienteListarVistaVend
	{
		...
		private void InitializeComponent()
		{
			...
			pServicios.Location = new Point(606, 48);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 33;
			...
			button5.Location = new Point(702, 8);
			...
			button3.Location = new Point(227, 72);
			...
			dataGridView1.Location = new Point(65, 195);
			...
			button1.Location = new Point(423, 72);
