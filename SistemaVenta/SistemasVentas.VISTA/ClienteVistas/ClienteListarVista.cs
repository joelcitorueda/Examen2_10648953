...
namespace SistemasVentas.VISTA.ClienteVistas
{
	public partial class ClienteListarVista : Form
	{
		...
		{
			// Obtener los datos de los clientes y asignarlos a la propiedad Clientes
			DatosCliente.Clientes = bss.ListarClienteBss();

			// Configurar el DataSource del DataGridView con los datos de los clientes
		...
		{
			this.Hide();
			ClienteEliminarVista fr = new ClienteEliminarVista();
			fr.Show();
			fr.FormClosing += frm_closing;
		}
